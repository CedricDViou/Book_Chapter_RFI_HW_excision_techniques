...
\begin{figure}
    ...
    \caption{Spectrogram of uGMRT antenna showing broadband (powerline RFI) and narrowband (communication transmitters) RFI in 250-500 MHz band. Broadband powerline RFI is seen to be repeating every 10ms (submultiple of 50Hz powerline frequency)}
    \label{fig:ugmrt-rfi}
\end{figure}
